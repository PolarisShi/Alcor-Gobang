function [theta, cost] = stackminiBatchNadam(theta, alpha, beta1, beta2, epsilon, num_iters, ...
...
m_flat = zeros(l, 1);
for t = 1 : num_iters
    [cost, g] = stackedAECost(theta, hiddenSize(end), outputSize, ...
                              netconfig, lambda, X, y, G);
